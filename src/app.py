...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice teamwork and skills on the field for soccer matches",
    ...
    "Art Workshop": {
        "description": "Explore drawing, painting, and creative expression with various media",
